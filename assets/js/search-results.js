//Get query parameters from url sting
getParams();
...
function getParams() {
  ...
  var searchTerm = searchParamsArr[0].split("=").pop();
  var searchFormat = searchParamsArr[1].split("=").pop();

  // document.getElementById('search-term').value = searchTerm;
  // document.getElementById('search-format').value = searchFormat;
  
  console.log(searchTerm + " " + searchFormat);

  fetchLOCSearchResults(searchTerm, searchFormat);
}
